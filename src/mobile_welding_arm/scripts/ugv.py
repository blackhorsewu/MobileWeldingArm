...
'''
  ...
  On 18 October 2023, this file is renamed as
  File name: ugv.py
...
class UGV:
  def __init__(self, model):
    self.model = model
    self.robot = None # Initially, there is no robot on the UGV yet
    pass
  ...
  # Move the UGV to the Marker
  # There should be a "distance" from the marker on its Z-axis to the camera
  def move2marker(self, distance):
