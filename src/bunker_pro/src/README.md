# ROS Packages for Bunker Pro Mobile Base

## Packages

* bunker_pro_base: a ROS wrapper around Bunker Pro SDK to monitor and control the robot
* bunker_pro_bringup: launch and configuration files to start ROS nodes 
* bunker_pro_msgs: bunker pro related message definitions
* bunker_pro_description: the URDF file and launch files to show the UGV
